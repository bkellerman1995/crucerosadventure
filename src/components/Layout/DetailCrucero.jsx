...
export function DetailCrucero() {
  ...
  //Url para acceder a la imagenes guardadas en la base de datos
      ...
      {data && (
        <Grid container spacing={2}>
          ...
          <Grid size={7}>
            ...
            <Typography component="span" variant="subtitle1">
              <Box fontWeight="bold">Fechas y precios de habitaciones:</Box>
              <List
                sx={{
                  width: "100%",
                  maxWidth: 360,
              ...
              >
                ...
                {data.fechasPreciosHabitaciones.map((item) => (
                  <ListItemButton key={item.id}>
                    ...
                    <ListItemText primary={`Fecha de salida: ${item.fechaSalida}`} />
                  </ListItemButton>
                ))}
              </List>
            </Typography>
