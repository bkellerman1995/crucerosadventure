...
CREATE TABLE `barco` (
  ...
  `cantHabitaciones` int(10) DEFAULT NULL,
  PRIMARY KEY (`idbarco`)
...
INSERT INTO `barco` VALUES (1,'starfish',2500,0),(2,'jellyfish',3000,NULL),(3,'walrus',2000,NULL),(4,'mussel',2500,NULL),(5,'catfish',2750,NULL),(6,'clam',3000,NULL),(7,'lobster',3500,NULL),(8,'seal',2300,NULL),(9,'cod',2600,NULL),(10,'sole',2400,NULL);
...
INSERT INTO `categoriahabitacion` VALUES (1,'Regular'),(2,'Especial'),(3,'Premium'),(4,'VIP');
...
CREATE TABLE `habitacion` (
  ...
  PRIMARY KEY (`idHabitacion`,`idcategoriaHabitacion`),
  KEY `fk_habitacion_categoriaHabitacion1_idx` (`idcategoriaHabitacion`),
  KEY `fk_habitacion_barco` (`idbarco`),
  CONSTRAINT `fk_habitacion_barco` FOREIGN KEY (`idbarco`) REFERENCES `barco` (`idbarco`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `habitacion` VALUES (1,'HabitacionPrueb','HabitacionPrueba',3,5,10,1,1),(2,'HabitacionPrueb','HabitacionPrueba',3,5,10,1,2),(3,'HabitacionPrueb','HabitacionPrueba',3,5,10,1,2),(4,'HabitacionPrueb','HabitacionPrueba',5,8,15,2,7),(5,'HabitacionPrueb','HabitacionPrueb',5,8,15,2,6),(6,'HabitacionPrueb','HabitacionPrueb',5,8,15,2,5),(7,'HabitacionPrueb','HabitacionPrueb',8,10,20,3,4),(8,'HabitacionPrueb','HabitacionPrueb',10,12,30,4,3),(9,'HabitacionPrueb','HabitacionPrueb',3,5,10,1,2),(10,'HabitacionPrueb','HabitacionPrueba',5,8,15,2,1);
...
INSERT INTO `huesped` VALUES ('01','Juan Hernández'),('02','Andrea Gutiérrez');
...
INSERT INTO `itinerario` VALUES ('it001','14:00:00','prt01'),('it002','14:00:00','prt02'),('it003','14:00:00','prt03'),('it004','14:00:00','prt04'),('it005','14:00:00','prt05'),('it006','14:00:00','prt06'),('it007','14:00:00','prt07'),('it008','14:00:00','prt08'),('it009','14:00:00','prt09'),('it010','14:00:00','prt10'),('it011','14:00:00','prt11');
...
INSERT INTO `pais` VALUES ('aru01','Aruba'),('col01','Colombia'),('crc01','Croacia'),('cur01','Curacao'),('grc01','Grecia'),('mnt01','Montenegro'),('mx01','México');
...
CREATE TABLE `puerto` (
  ...
  CONSTRAINT `fk_puerto_pais1` FOREIGN KEY (`idPais`) REFERENCES `pais` (`idPais`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `puerto` VALUES ('prt01','Cabo San Lucas','mx01'),('prt02','Mazatlán','mx01'),('prt03','Puerto Vallarta','mx01'),('prt04','Bay of Kotor','mnt01'),('prt05','Kotor','mnt01'),('prt06','Atenas (El Pireo)','grc01'),('prt07','Santorini','grc01'),('prt08','Split','crc01'),('prt09','Cartagena','col01'),('prt10','Curacao','crc01'),('prt11','Aruba','aru01');
...
-- Dump completed on 2025-02-20 20:12:48
